 ...
 */
module.exports.getCurrentManifest = async function getCurrentManifest({
  github,
  owner,
  branch,
}) {
...
module.exports.updateManifest = async function updateManifest({
  ...
  if (!Object.keys(manifest).length) {
    manifest = await module.exports.getCurrentManifest({ github, owner, branch })
  }
  ...
  const differences = diff(manifest, newManifest)
...
module.exports.getNextBase = function getNextBase(base) {
